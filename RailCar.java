...
public class RailCar extends Vehicle {
	...
	/**
	 * Changes the color of the car depending whether or not selected.
	 */
	public void changeColor() {
		if (this.isSelected) // cehck for the trailer.
		{
			color = Color.RED;
		} else {
			color = Color.BLACK;
	...
	/**
	 * Selects the car by changing the color and setting the selected variable
	 * to true.
	 */
	public void isSelected() {
		isSelected = true;
		Vehicle temp = this.trailer;
		while (temp != null) {
			temp.isSelected();
			temp = temp.trailer;
		}
	...
	/**
	 * Deselects the car by changing the color and setting the selected variable
	 * to false.
	 */
