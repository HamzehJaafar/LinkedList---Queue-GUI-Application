...
public class TrainEngine extends Vehicle {
	...
	public TrainEngine(int x2, int y2) {
		super(x2, y2, 90, 40);
		isSelected = false;
	...
	/**
	 * Selects the train by changing the color and setting the selected variable
	 * to true.
	 */
	...
	/**
	 * Deselects the train by changing the color and setting the selected
	 * variable to false.
	 */
	...
	/**
	 * Changes the color of the train depending whether or not selected.
	 */
	@Override
